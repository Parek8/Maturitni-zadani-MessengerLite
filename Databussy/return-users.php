<?php
    ...
    while($result = $results->fetch_assoc())
    {
        ...
        echo  '<div class=" bg-light h-100 d-flex align-items-center search-result" style="position: relative; width: 25vw; z-index: 11;" name='.$result["id"].'>
                    ...
                    {
                        echo '<button class="btn btn-outline-success my-2 my-sm-0" style="float: right;display: inline-block;z-index: 12;" type="" name="'.$result["id"].'">Waiting for Accepting</button></div>';
                    }
                    else
                    {
